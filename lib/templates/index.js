...
<div class='styleguide-sidebar'>
  ...
  <label class='styleguide-sidebar-button' for='sidebar-toggle'></label>
  <label class='styleguide-sidebar-screen' for='sidebar-toggle'></label>
...
module.exports = {
  html, htmlHead, htmlBody, title, head, header, footer, sidebar,
