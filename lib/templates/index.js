...
const iframeHtml =
`<!doctype html><html class='styleguide-figure'><head><meta charset='utf-8'><style>html,body{margin:0 !important;padding:0 !important;background:transparent !important;}</style>
...
`<div class='styleguide-example {{class}}'>
  ...
  <iframe class='styleguide-iframe' src='{{{figureSrc}}}'></iframe>
  </div>
