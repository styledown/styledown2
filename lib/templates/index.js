...
const body =
`<div class='styleguide-body markdown-body'>
...
`<div class='styleguide-example {{class}}'>
  <div class='styleguide-example-figure {{class}}' data-js-example-parent>
    <div class='content'>
      <iframe class='styleguide-iframe' scrolling='no' src='{{base}}{{frameSrc}}'></iframe>
    </div>
    <div class='styleguide-example-toolbar'>
      <div class='button-group'>
        <button data-js-view-source data-js-example-class='-sm'>S</button>
        <button data-js-view-source data-js-example-class='-md'>M</button>
        <button data-js-view-source data-js-example-class='-lg'>L</button>
        <button data-js-view-source data-js-example-class='-xl'>XL</button>
      </div>
      <div class='button-group'>
